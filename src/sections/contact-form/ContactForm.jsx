...
function ContactForm() {
  const [formInputs, setFormInputs] = useState({ fullname: "", phone: "", email: "", message: "" });
  ...
  const submitHandler = (e) => {
    ...
    // Send email
    emailjs.send('service_05fedmk', 'template_k51296l', {
      ...
      .then((response) => {
        ...
        alert('Échec de l\'envoi du message. Veuillez vérifier votre connexion internet et réessayer.');
      });
  }
    ...
    <section className="wrapper">
      <div className="box">
        <div className="title-container">
          ...
          <h2 className="title">Collaborons ensemble pour atteindre l'excellence!</h2>
        </div>
        <ul>
          <li>
